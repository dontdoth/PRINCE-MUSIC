...
import config
from PRINCEMUSIC import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from PRINCEMUSIC.core.call import PRINCE
from PRINCEMUSIC.utils import seconds_to_min, time_to_seconds
from PRINCEMUSIC.utils.channelplay import get_channeplayCB
from PRINCEMUSIC.utils.decorators.language import languageCB
from PRINCEMUSIC.utils.decorators.play import PlayWrapper
from PRINCEMUSIC.utils.formatters import formats
from PRINCEMUSIC.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from PRINCEMUSIC.utils.logger import play_logs
...
@app.on_callback_query(filters.regex("PRINCEmousAdmin") & ~BANNED_USERS)
async def PRINCEmous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("PRINCEPlaylists") & ~BANNED_USERS)
@languageCB
